...
void loop() 
{
  ...
  //if (1)
  {
    ...
    //fSpeedKmh = 23.12, oHoverFeedback.iAmpR = 23452, oHoverFeedback.iSpeedR = (uint16_t) 52232, oHoverFeedback.iAmpL = 8;
     sMess = "#000000 " + String(fSpeedKmh,1) + "# #ff0000 " + String((int16_t)oHoverFeedback.iSpeedR) + " # #0000ff " + String((int16_t)oHoverFeedback.iOdomR)
          + " # #000000 " + String(oHoverFeedback.iAmpL/100) + "   ";
           
      lv_label_set_text(text_label, sMess.c_str());    
    }

    int32_t ai[SER_COUNT] = {oHoverFeedback.iGyroX/4+200,oHoverFeedback.iGyroY/4+200,oHoverFeedback.iGyroZ/4+200
